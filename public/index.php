...
<head>
  ...
  <meta name="theme-color" content="#E40063">
  <!-- Windows Phone -->
  <meta name="msapplication-navbutton-color" content="#E40063">
  <!-- iOS Safari -->
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="apple-mobile-web-app-status-bar-style" content="#E40063">
...
<header>
  ...
  <div>
    ...
    <button type="button" id="btn-main-menu" class="js-btn-main-menu">
      <div class="bar">
        <span></span>
        <span></span>
        <span></span>
      </div>
      <span id="btn-nav-text">Menu</span>
    </button>
